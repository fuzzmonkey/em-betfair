...
describe Betfair::Client do
  ...
  describe "get_market" do
    ...
    it "should handle an OK response" do
      ...
      EM::run {
        Fiber.new do
          rsp = @bf_client.get_market "104968439"
          rsp.successfull.should eq true
          rsp.error.should eq ""
          rsp.hash_response.should be_an_instance_of Hash
  ...
  describe "get_silks_v2" do
    ...
    it "should handle an OK response" do
      ...
      EM::run {
        Fiber.new do
          rsp = @bf_client.get_silks_v2 ["104968439"]
          rsp.successfull.should eq true
          rsp.error.should eq ""
          rsp.hash_response.should be_an_instance_of Hash
  ...
  describe "get_market_prices_compressed" do
    ...
    it "should handle an OK response" do
      ...
      EM::run {
        Fiber.new do
          rsp = @bf_client.get_market_prices_compressed "104968512"
          rsp.successfull.should eq true
          rsp.error.should eq ""
          rsp.hash_response.should be_an_instance_of Hash
